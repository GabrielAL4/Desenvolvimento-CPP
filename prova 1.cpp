...
int aux_ano[12]={0}, aux_tipo[12]={0};
float mediaPss=0,tot_f=0,tot_ns=0,tot_ss=0,med_f,med_ns,med_ss, percpm=0, aux_hp[12]={0};
int maior=0;
...
void media()
{
	printf("A media da plataforma fixa e de : %.2f\n",med_f);
	printf("A media da plataforma navio sonda  e de : %.2f\n",med_ns);
	printf("A media da plataforma semi submersivel e de : %.2f\n",med_ss);
}
